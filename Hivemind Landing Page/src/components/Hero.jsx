...
const HighlightedText = ({ children }) => (
  <span className="relative inline-block">
    ...
    <span className="absolute inset-0 bg-gradient-to-r from-emerald-500 to-emerald-500 bg-[length:200%_100%] -rotate-2 translate-y-2 rounded animate-highlighter" 
      style={{
      ...
      <div className="container relative mx-auto px-4" ref={parallaxRef}>
        <div className="relative z-10 max-w-4xl mx-auto text-center mb-16 md:mb-20 lg:mb-24">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6">
            ...
            <HighlightedText>LearnGraph AI</HighlightedText>
          </h1>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-6 lg:mb-8">
            Adaptive learning powered by AI knowledge graphs. Upload your materials,
            track mastery with visual concept mapping, and learn with AI-matched study partners.
          </p>
